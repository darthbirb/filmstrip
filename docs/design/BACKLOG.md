...
on the undo journal (FEATURES.md "Export and undo"): a file's Rename and Delete, and a folder's
New Folder, Move to…, Rename and Delete. New Folder lands a row already in its name field,
