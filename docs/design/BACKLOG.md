...
for it; once the fix is drawn and built, the entry is deleted.
...
## The pane: black bars around the picture
...
## The pane: an action bar, and its own video controls
...
## Folded navigation still goes places
...
## Empty places say what they are
